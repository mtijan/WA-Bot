...
Chatbot AI Token Optimization / Hybrid RAG berstatus **IN_PROGRESS — LOCAL**: migrations 024–026, default/maksimum output 2.048, prompt/usage/budget/retry, schema RAG + FTS, extractor/chunker, durable enqueue, gated polling, dan state job eksplisit telah diimplementasikan lokal. Migration 026 memetakan state legacy menjadi `PENDING/RUNNING/READY/FAILED/SUPERSEDED` tanpa mencampurnya dengan readiness lexical/embedding. Tiga puluh tujuh dari 128 item DONE; RAG-0011 tetap parsial. Focused RAG 53/53 dan backend 180/180 lulus pada 2026-09-11. Poller dan budget moneter default nonaktif; database runtime belum dimigrasi, claim/retry/process/retrieval belum dibuat, dan deploy/UAT belum dilakukan.
